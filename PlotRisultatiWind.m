...
for i = [2 5 10]
    ...
    %for kk = in:fin
        ...
        %for j = 1:length(Pl(i).month)
            ...
            y_pale(kk + h*in) = E_wind(lunghezza + j, kk);
        end
        in = in + 1;
    ...
    plot(t,y_pale, 'color', 'c')
    title('Caratteristiche Energia batterie - Energia carico - Energia PV - Energia eolica del periodo a consumo '+ periodi(s))
    legend('Energy load','Energy pv','Energy battery', 'Energy wind')
